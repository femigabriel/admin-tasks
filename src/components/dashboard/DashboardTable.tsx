      ...
      <div className=" cursor-pointer text-[12px] font-semibold">
        {rows.map((list, index) => {
          ...
          return (
            <div
              key={index}
              className="grid grid-cols-4 px-3 list text-[#888] border border-x-0 border-t-0 border-gray-200 "
            >
              ...
              <div className="flex ">
                ...
                <button className="bg-sky-100 edit h-[25px] px-2 rounded-md mt-1">
                  <EditOutlined
